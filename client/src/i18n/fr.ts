...
export const fr = {
  ...
  history: {
    ...
    socket: {
      ...
      fiftyFiftyResult: (winner: string, pts: number, stars: number) => `🎲 FIFTY-FIFTY ! ${winner} gagne +${pts} pts bonus et +${stars}⭐`,
  ...
  specialCards: {
    ...
    DOUBLE: {
      icon: '×2', title: 'X2', role: 'Doublement de score et d\'étoiles',
      how: 'La valeur ET les étoiles de ta dernière carte Score gagnée sont multipliées par 2.',
      tip: 'Gagne-la après une carte à forte valeur ou avec beaucoup d\'étoiles pour maximiser l\'effet.',
    },
    STEAL: {
      icon: '🦅', title: 'VOL', role: 'Voler une carte adverse',
      how: 'Tu prends la carte du dessus de la pile d\'un adversaire de ton choix et tu la places dans ta propre pile. Les points bonus déjà gagnés ne sont pas transférés.',
      tip: 'Cible le joueur avec la carte la plus précieuse au sommet.',
    },
    YUMI: {
      icon: '✨', title: 'YUMI', role: 'Récupérer sa carte YUMI',
      how: 'Tu récupères ta carte YUMI en main si elle a déjà été jouée lors d\'une mène précédente. Elle est à nouveau jouable dès la mène suivante.',
      tip: 'Très utile si tu as joué ta YUMI tôt — tu peux l\'utiliser une seconde fois !',
    },
    RECYCLAGE: {
      icon: '♻️', title: 'RECYCLAGE', role: 'Recharge immédiate',
      how: 'Tu effectues immédiatement une Recharge complète : ta main 1-8 est reconstituée et une nouvelle carte mystère est tirée.',
    ...
    FIFTY_FIFTY: {
      ...
      how: 'Tu gagnes immédiatement 2 points bonus ET la carte vaut 3 étoiles comptabilisées en fin de manche.',
      tip: 'Un gain équilibré entre les deux compteurs — utile dans toutes les situations.',
    },
    JACKPOT: {
      icon: '💰', title: 'JACKPOT', role: 'Gros gain en points bonus',
      how: 'Tu gagnes immédiatement 5 points bonus qui s\'ajoutent à ton compteur bonus.',
      tip: 'Un gain massif et immédiat — très puissant pour la catégorie bonus.',
    },
    CONSTELLATION: {
      icon: '🌟', title: 'CONSTELLATION', role: 'Gros gain en étoiles',
      how: 'La carte vaut 5 étoiles comptabilisées en fin de manche pour la course aux étoiles.',
      tip: 'Très puissante pour dominer la catégorie étoiles.',
    },
  },
