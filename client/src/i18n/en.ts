...
export const en: Translations = {
  ...
  history: {
    ...
    socket: {
      ...
      fiftyFiftyResult: (winner: string, pts: number, stars: number) => `🎲 FIFTY-FIFTY! ${winner} gains +${pts} bonus pts and +${stars}⭐`,
  ...
  specialCards: {
    ...
    DOUBLE: {
      icon: '×2', title: 'X2', role: 'Score and star doubling',
      how: 'The value AND the stars of your last won Score card are both multiplied by 2.',
      tip: 'Win it after a high-value or high-star card to maximise the effect.',
    },
    STEAL: {
      icon: '🦅', title: 'STEAL', role: 'Steal an opponent\'s card',
      how: 'You take the top card from an opponent\'s pile of your choice and add it to your own pile. Bonus points already earned are not transferred.',
      tip: 'Target the player with the most valuable card on top.',
    },
    YUMI: {
      icon: '✨', title: 'YUMI', role: 'Recover your YUMI card',
      how: 'You recover your YUMI card in hand if it was already played in a previous trick. It can be played again from the next trick.',
      tip: 'Very useful if you played your YUMI early — you get to use it a second time!',
    },
    RECYCLAGE: {
      icon: '♻️', title: 'RECYCLAGE', role: 'Immediate recharge',
      how: 'You immediately perform a full Recharge: your hand 1-8 is rebuilt and a new mystery card is drawn.',
    ...
    FIFTY_FIFTY: {
      ...
      how: 'You immediately gain 2 bonus points AND the card is worth 3 stars counted at the end of the round.',
      tip: 'A balanced gain across both counters — useful in any situation.',
    },
    JACKPOT: {
      icon: '💰', title: 'JACKPOT', role: 'Big bonus points gain',
      how: 'You immediately gain 5 bonus points added to your bonus counter.',
      tip: 'A massive and immediate gain — very powerful for the bonus category.',
    },
    CONSTELLATION: {
      icon: '🌟', title: 'CONSTELLATION', role: 'Big star gain',
      how: 'The card is worth 5 stars counted at the end of the round for the star race.',
      tip: 'Very powerful to dominate the star category.',
    },
  },
