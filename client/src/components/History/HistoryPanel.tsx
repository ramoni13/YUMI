...
function getEventStyle(kind: GameEvent['kind']): { icon: string; rowClass: string } {
  switch (kind) {
    ...
    case 'SPECIAL_DOUBLE':        return { icon: '×2', rowClass: styles.rowSpecial };
        case 'SPECIAL_YUMI':          return { icon: '✨', rowClass: styles.rowSpecial };
    case 'SPECIAL_RECYCLAGE':     return { icon: '♻️', rowClass: styles.rowSpecial };
    case 'SPECIAL_INVERSION':     return { icon: '🌀', rowClass: styles.rowSpecial };
    case 'SPECIAL_FIFTY_FIFTY':   return { icon: '🎲', rowClass: styles.rowSpecial };
